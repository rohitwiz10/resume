...
const Enhanced3DHero = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      ...
      setRotateX((y - height / 2) / 10);
      setRotateY((x - width / 2) / 10);
    };
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div 
          ...
          style={{
            transform: `translate3d(${mousePosition.x * 0.05}px, ${mousePosition.y * 0.05}px, 0px) rotateX(${rotateX}deg) rotateY(${rotateY}deg)`
          }}
        />
      ...
      {/* Enhanced Hero Illustration with 3D effect */}
      <div className="absolute right-10 top-1/2 transform -translate-y-1/2 hidden lg:block pointer-events-none">
        <div 
          className={`transition-all duration-1000 delay-800 transform-gpu ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}
          style={{
            transform: `translate3d(0, 0, 50px) rotateY(${rotateY * 0.5}deg) rotateX(${rotateX * 0.3}deg)`
          }}
        >
          <div className="relative group">
            <img 
              ...
              className="w-80 h-80 object-cover rounded-2xl shadow-2xl transform rotate-3 group-hover:rotate-0 transition-all duration-500 filter hover:contrast-110"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-charcoal/20 to-transparent rounded-2xl group-hover:from-charcoal/30 transition-all duration-500"></div>
            
            {/* Floating elements around image */}
            <div className="absolute -top-4 -right-4 w-8 h-8 bg-charcoal rounded-full animate-pulse-3d shadow-lg"></div>
            <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-charcoal/70 rounded-full animate-pulse-3d delay-500 shadow-lg"></div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 
            ...
            style={{
              transform: `translate3d(0, 0, 20px) rotateX(${rotateX * 0.1}deg)`,
          ...
          <div 
            className={`mb-8 transition-all duration-1000 delay-400 transform-gpu ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            style={{
              transform: `translate3d(0, 0, 15px) rotateX(${rotateX * 0.05}deg)`
            }}
          >
          ...
          <div 
            ...
            style={{
              transform: `translate3d(0, 0, 10px) rotateX(${rotateX * 0.03}deg)`
            }}
          >
          ...
          <div className={`flex flex-col sm:flex-row gap-6 mb-12 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <Button 
              ...
              style={{
                transform: `translate3d(0, 0, 5px) rotateX(${rotateX * 0.02}deg)`,
                boxShadow: '0 20px 40px rgba(30, 30, 30, 0.2)'
              }}
            >
          ...
          <div className={`flex gap-6 mb-12 transition-all duration-1000 delay-800 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            {[
              ...
              <a 
                ...
                style={{
                  transform: `translate3d(0, 0, ${5 + index * 2}px) rotateY(${rotateY * 0.1}deg)`,
          ...
          <div className={`transition-all duration-1000 delay-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
            <button 
              ...
              style={{
                transform: `translate3d(0, 0, 3px) rotateX(${rotateX * 0.02}deg)`
              }}
            >
